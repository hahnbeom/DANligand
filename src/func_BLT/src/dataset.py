...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Remove self edges
        G_bnd = myutils.remove_self_edges(G_bnd)
        G_atm = myutils.remove_self_edges(G_atm)
        G_res = myutils.remove_self_edges(G_res)
...
def collate(samples):
    ...
    if True:
        ...
        # tmp
        # BLT: r2a maps each atom to one of the residues (presumably the
        # residue is is part of...)
