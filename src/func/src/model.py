...
class SE3Transformer(nn.Module):
    ...
    def __init__(self, 
        ...
        # simple Tranformer encoder for a self-attention
        #if self.use_transformer:
        #    enc_layer_1 = Transformer.EncoderLayer(d_model=1, d_ff=1, heads=1, p_drop=0.0)
        #    encoder_1 = Transformer.Encoder(enc_layer_1, 1, 1)
        #    Cblock.append(encoder_1)
    ...
    def forward(self, G_bnd, G_atm, G_res, r2a):
        ...
        #cat = torch.nn.functional.softmax(torch.matmul(w,cat))
        cat = torch.matmul(w,cat)
