...
class DataSet(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index): #N: maximum nodes in batch
        ...
        try:
            ...
            #print(target, Grec.number_of_nodes(), Grec.number_of_edges())
    ...
    def read_by_single_mol2(self, target, target_lig_list, keyatomf, K):
        ...
        for lig in target_lig_list:
            ...
            #print(target, lig, keyidx, atms, Glig.number_of_nodes(), blabel_list[-1], keyxyz)
...
def ligand_graph_from_mol2(mol2,dcut,
    ...
    Glig = generate_ligand_graph(elems, qs, bonds, borders, xyz, nneighs, atms, mode=mode)
