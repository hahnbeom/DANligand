...
class TRArgs:
    def __init__(self,
        ...
        self.params['n_trigonometry_module_stack'] = n_trigonometry_module_stack
...
args_monitor_debug = copy.deepcopy(args_monitor)
args_monitor_debug.modelname = 'debug'
args_monitor_debug.datasetf = 'data/debug.txt'
