...
class SE3TransformerWrapper(nn.Module):
    ...
    def __init__(self, num_layers=2, num_channels=32, num_degrees=3, n_heads=4, div=4,
        ...
        WBblock.append(nn.Linear(32,l1_out_features,bias=False))
        WBblock.append(nn.Tanh()) #range -1~1

        # sigma
        SBblock.append(nn.Linear(32,nGMM,bias=True))
        ...
        for i in range(ntypes):
            Rblock.append(nn.Linear(l1_out_features,nGMM,bias=False)) #weight vector on each channel!
